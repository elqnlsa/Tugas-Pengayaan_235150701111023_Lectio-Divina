        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 4:
                    ...
                    // EDIT DISINI
                    System.out.print("Nomor meja: ");
                    int noMejaHapus = scanner.nextInt();
                    hapusPelanggan(noMejaHapus);
                    System.out.println("Nomor meja " + noMejaHapus + " sudah dihapus");
                    break;
                case 5:
                    ...
                    if(totalHarga > 0){
                        ...
                        System.out.println("Meja " + nomorMejaHarga + " belum memesan atau meja tidak valid");
                    }
                    break;
                case 6:
